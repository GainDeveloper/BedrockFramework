...
public class PrototypeEditor : Editor 
{
	...
	public override void OnInspectorGUI () 
	{
        ...
        serializedPrototypeObject.PrototypeObject = EditorGUILayout.ObjectField(serializedPrototypeObject.PrototypeObject, typeof(Prototype), false);
    ...
    public class SerializedPrototypeEditor
    {
        ...
        public static void UpdateAllPrototypes()
        {
            ...
            {
                SerializedPrototypeEditor serializedPrototypeEditor = new SerializedPrototypeEditor(new SerializedObject(AssetDatabase.LoadAssetAtPath<Prototype>(AssetDatabase.GUIDToAssetPath(assetGUID))));
        ...
        public void UpdatePrototypeHierachy()
        {
            ...
            Prototype prototype = serializedObject.FindProperty("prototype").objectReferenceValue as Prototype;
